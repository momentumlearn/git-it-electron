...
// const completed = require(path.join(__dirname, 'challenge-completed.js'))
...
const markChallengeCompleted = function (challenge) {
  // this dom stuff has to happen in a renderer process so we need the context bridge
  
  const window = BrowserWindow.getFocusedWindow()
  console.log("Challenge: ", challenge)
  window.webContents.send('challengeCompleted', challenge) 
  console.log("challenge completed MAIN")
